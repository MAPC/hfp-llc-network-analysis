...
This is a fork of Dr. Eric Robsky Huntley's work [here (https://github.com/mit-spatial-action/who-owns-mass-processing)]. This repo is being updated by MAPC to run on homeownership data from the Warren Group rather than the parcel data used in Dr. Robsky Huntley's original analysis.
